<x-layout title="Register Page">
    <main>
        <div class="container mx-auto">
            <form class="lg:w-[30%] flex flex-col mx-auto p-5 gap-5 mt-5" method="post" action="{{ route('register.store') }}">
                @csrf
                ...
                <div class="flex flex-col gap-5 text-sm">
                    <x-forms.input-field placeholder="First Name" id="first_name" />
                    <x-forms.input-field placeholder="Last Name" id="last_name" />
                    ...
                    <x-forms.input-field placeholder="Confirm Password" id="password_confirmation" type="password" />
                </div>
